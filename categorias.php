        ...
        <div id="col-right">
            ...
            <div class="box">
                ...
                <?php
                  ...
                  $tema= array("Computacion", "Ciencia","Historia","Idiomas","Literatura","Programacion");
                  $idioma=array("Español","Ingles","Portugues");


                  if(in_array($categoria,$tema))
                  {
                    $sql = "SELECT * FROM curso WHERE Tema='$categoria'";
                  }elseif (in_array($categoria ,$idioma)) {
                    $sql = "SELECT * FROM curso WHERE Idioma='$categoria'";
                  }elseif ($categoria=="Novedades") {
                    $sql = "SELECT * FROM curso order by Id DESC";
                  }elseif ($categoria=="Todos") {
                    $sql = "SELECT * FROM curso";
                  }/*else
                  {
                    $sql = "SELECT * FROM juegos WHERE categoria='$categoria'";
                  }*/
