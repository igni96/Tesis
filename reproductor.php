    ...
    <div id="cols2" class="box">
        ...
        <div id="col-right">
            ...
            <div class="box">
              ...
              $numeroCap=$_GET['numeroCap'];
              $idCurso=$_GET['idCurso'];


              $sql = "SELECT * FROM capitulo WHERE (IdCurso=$idCurso and Orden=$numeroCap)";
              $result = $conn->query($sql);
            ...
            echo "
            <a href='curso.php?id=".$row["IdCurso"]."'><button id='botonVueltaCurso'>Volver al curso</button></a>
            <div id='titulocapitulo'>" . $row["Nombre"] . " </div>
            <div id='reproductor'>

                  <iframe width='100%' height='100%' src=".$row["video"]." frameborder='0' allowfullscreen></iframe>
